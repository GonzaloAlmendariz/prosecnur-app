...
.validacion_upstream_universe <- function(sid, base_nombre = NULL) {
  ...
  list(
    ...
    corrections = filter$corrections %||% list(),
    exclusion_rules = filter$exclusion_rules %||% list(),
    ...
    correction_changes = as.integer(audit$correction_changes %||% audit$corrected %||% 0L),
    excluded_rules = as.integer(audit$excluded_rules %||% 0L),
    correction_audit = audit$corrections %||% list(),
    exclusion_audit = audit$exclusion_rules %||% list(),
