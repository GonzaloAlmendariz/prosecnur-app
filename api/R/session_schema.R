...
session_schema <- function() {
  tabla <- c(
    ...
    "dashboard_rp_inst",           "literal", "cache_stripped", "dashboard_source.R", "session_set", "re-derivada en el warmup (o lazy en su primer uso); al load solo en modo público",
    "dashboard_rp_data",           "literal", "cache_stripped", "dashboard_source.R", "session_set", "re-derivada en el warmup (o lazy en su primer uso); al load solo en modo público",
    ...
    "calc_muestra_aulas_frame",    "literal", "persistible",    "router_calc_muestra.R", "session_set", "sanitizada en save: unique_student_ids SUBROGADOS sin mapa (F114) y population/exclusions fuera",
