...
session_schema <- function() {
  tabla <- c(
    ...
    "monitoreo_client_report_sheet_events", "literal", "persistible", "router_monitoreo.R", "session_set", "",
    "monitoreo_sheet_publish_events", "literal", "persistible", "router_monitoreo.R", "session_set", "",
