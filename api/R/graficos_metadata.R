...
.GRAFICADORES_META <- list(
  ...
  p_barras_agrupadas = list(
    ...
    args = c(list(
      ...
      list(name = "normalizar_etiquetas", label = "Normalización de etiquetas", tipo_input = "choice", grupo = "textos",
           descripcion = "Uniforma la caja de las categorías del instrumento. «Mayúscula inicial» arregla listas transcritas en MAYÚSCULAS sin tocar el dato.",
           default = "ninguna",
           choices = list(
  ...
  p_barras_categoricas = list(
    ...
    args = c(list(
      ...
      list(name = "formato_valor", label = "Formato de etiquetas", tipo_input = "choice", grupo = "valores",
           descripcion = "Qué se escribe sobre cada barra: el porcentaje, el número de casos, o los dos.",
           default = "porcentaje",
           choices = list(
      ...
      list(name = "ancho_max_eje_x", label = "Wrap de etiquetas", tipo_input = "number", grupo = "espacio",
           descripcion = "Caracteres por línea antes de partir la etiqueta de una categoría. Menos caracteres = más líneas y barras más separadas.",
      ...
      list(name = "mostrar_eje_y", label = "Mostrar eje Y", tipo_input = "bool", grupo = "estilo",
           descripcion = "Dibuja la escala numérica del eje. Con las cifras sobre las barras suele sobrar.",
           default = FALSE),
      list(name = "mostrar_linea_eje_x", label = "Mostrar línea del eje X", tipo_input = "bool", grupo = "estilo",
           descripcion = "Línea horizontal en la base de las barras.",
           default = FALSE),
      list(name = "mostrar_linea_eje_y", label = "Mostrar línea del eje Y", tipo_input = "bool", grupo = "estilo",
           descripcion = "Línea vertical a la izquierda de las barras.",
           default = FALSE),
      list(name = "mostrar_grid_y", label = "Mostrar grilla horizontal", tipo_input = "bool", grupo = "estilo",
           descripcion = "Líneas horizontales de referencia detrás de las barras.",
           default = FALSE),
      ...
      list(name = "color_texto_barras", label = "Color de etiquetas", tipo_input = "color", grupo = "valores",
           descripcion = "Color de la cifra que va sobre cada barra.",
           default = "#081F5C")
    ), .args_graf_comunes())
  ),
  ...
  p_barras_apiladas = list(
    ...
    args = c(list(
      ...
      list(name = "mostrar_significancia", label = "Marcar diferencias significativas", tipo_input = "bool", grupo = "datos",
           default = FALSE,
           descripcion = "Agrega a cada segmento la letra de los grupos a los que supera de forma significativa, con la misma prueba que usan las tablas de cruces. Necesita un cruce con dos o más grupos."),
      list(name = "significancia_alpha", label = "Nivel de significancia", tipo_input = "number", grupo = "datos",
           default = 0.05, min = 0.001, max = 0.2, step = 0.005,
           descripcion = "Umbral del contraste. 0.05 es el estándar; bajarlo exige diferencias más grandes para marcar."),
      list(name = "excluir_opciones", label = "Opciones a ocultar", tipo_input = "codigos_list", grupo = "filtro",
  ...
  p_radar = list(
    ...
    args = c(list(
      ...
      list(name = "corte_etiqueta", label = "Nombre del indicador", tipo_input = "string", grupo = "datos",
           depende = list(arg = "modo", valores = list("publicos")),
           descripcion = "Aparece como subtítulo del gráfico: «% De acuerdo + Totalmente de Acuerdo». Vacío = se arma con las etiquetas de los códigos elegidos."),
      ...
      list(name = "tabla_titulo", label = "Encabezado de la primera columna", tipo_input = "string", grupo = "datos",
           depende = list(arg = "modo", valores = list("publicos")),
           descripcion = "Vacío = «Tema». El nombre del indicador no va aquí sino en el subtítulo del gráfico, donde se lee aunque la tabla esté apagada."),
      list(name = "tabla_encabezados", label = "Nombres de las columnas", tipo_input = "base_labels", grupo = "datos",
           depende = list(arg = "modo", valores = list("publicos")),
           descripcion = "Una caja por base del estudio. Lo que dejes vacío conserva el nombre técnico con el que llega («docentes», «egresados»)."),
      list(name = "tabla_ancho_tema", label = "Ancho de la primera columna (%)", tipo_input = "number", grupo = "datos",
           min = 20, max = 80,
           depende = list(arg = "modo", valores = list("publicos")),
           descripcion = "Vacío = lo que pida el contenido, que con un encabezado largo desbalancea la tabla. Con un valor, la primera columna toma ese porcentaje y las demás se reparten el resto en partes iguales."),
      list(name = "tabla_proporcion", label = "Ancho de la tabla frente al radar", tipo_input = "number", grupo = "datos",
           min = 0.3, max = 3, step = 0.1,
           depende = list(arg = "modo", valores = list("publicos")),
           descripcion = "1 deja el reparto por defecto. Súbelo cuando la tabla tenga muchas columnas; bájalo cuando el radar sea lo que hay que mirar."),
  ...
  barras_apiladas = list(
    ...
    args = list(
      ...
      list(name = "legend_espaciado",     label = "Espaciado entre items de leyenda", tipo_input = "number", grupo = "estilo",
           default = 6,
           descripcion = "Puntos de aire entre el cuadrito de color y su texto, y entre items contiguos."),
  ...
  acnur_kobo_cruncher_plus = list(
    ...
    presets = list(
      base = list(
        ...
        partner_logo_section = TRUE,
        partner_logo_section_variant = "white",
        partner_logo_section_left = 0.46,
        partner_logo_section_top = 6.75,
        partner_logo_section_height = 0.60,
