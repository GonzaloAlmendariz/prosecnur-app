...
.GRAFICADORES_META <- list(
  ...
  p_radar = list(
    ...
    args = c(list(
      ...
      list(name = "tabla_encabezados", label = "Nombres de las columnas", tipo_input = "textarea", grupo = "datos",
           depende = list(arg = "modo", valores = list("publicos")),
           descripcion = "Una línea por columna, formato «base=Título». La clave es el nombre de la base tal como llega del estudio (docentes, egresados). Lo que no nombres se queda igual."),
