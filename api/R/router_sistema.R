  ...
  pr |>
    ...
    plumber::pr_get("/api/session/state", wrap_endpoint(function(req, res) {
      ...
      list(
        ...
        # Los dos de arriba son de la base ACTIVA. En un estudio multibase eso
        # daba Graficos por hecho con bases sin un solo mazo; ver
        # graficos_cobertura_bases.R.
        graficos_bases_sin_mazo = I(as.list(graficos_bases_sin_mazo(
          names(bases), s$graficos_status_por_base
        ))),
