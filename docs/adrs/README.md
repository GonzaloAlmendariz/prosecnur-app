...
| [0063](0063-el-mazo-se-deriva-de-la-declaracion.md) | Aceptada | 2026-08-06 | La declaración de equivalencias es una fuente del plan sugerido de Gráficos y no un mecanismo aparte: una lámina por `diapositiva` declarada, un tema por pregunta y una barra por público; se propone y se previsualiza, nunca sobrescribe el plan por su cuenta, y lo no graficable se reporta en vez de fabricarse |
