...
| [0070](0070-el-grafico-nativo-cuesta-el-reposicionamiento-de-etiquetas.md) | Aceptada | 2026-08-10 | El motor PPT sigue emitiendo formas y no charts nativos OOXML: `mschart` reproduce el XML del deck de acreditación rasgo a rasgo, pero PowerPoint no mueve una etiqueta que no entra y devolvería a mano el reposicionamiento que el motor resuelve solo (62 de 91 etiquetas del deck de referencia están desplazadas a mano) |
