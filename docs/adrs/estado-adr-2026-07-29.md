...
| [0035 — Editor](0035-editor-xlsform-coleccion-multi-formulario.md) | Aceptado | Muestra estática: colección multi-formulario, espejo activo, persistencia y tests coherentes con la decisión. | Inconsistencia crítica de identidad: comparte 0035 con Cálculo. Regularizar sin borrar la historia. |
