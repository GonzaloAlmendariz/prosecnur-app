...
| P16 | **Dos láminas del mismo tipo no salen iguales** | escalado del canvas al cajón | ◐ **causa localizada, y no está en el graficador**. Traza sobre las llamadas reales, separando PPT de Word (el generador corre los dos y sus cifras se mezclaban): el graficador produce **3 grosores** —1.29 ×52, 1.466 ×2, 1.571 ×4— y en el PPT acaban **22**, de 0.693 a 2.068 cm, con un factor implícito de **0.54× a 1.60×**. Lo que dispersa es el paso que **encaja el canvas en el cajón del slide**, que comprime o estira según el contenido. Los tres altos de fila que se veían llegar eran todos legítimos: **0.651** preset del proyecto, **0.74** override deliberado de la lámina 15, **0.55** del preset de **Word** —no entra al PPT—. **Tres remedios descartados con medición** por atacar el graficador, que ya es consistente |
