...
| P16 | **Dos láminas del mismo tipo no salen iguales** | reparto de alto · regla **B4** | ◐ **ahora se mide**: no había vara —B3 sólo mira dentro de una lámina—. B4 agrupa por firma (los gráficos que tiene y las barras de cada uno) y marca los grupos que se separan más de 0.10 cm. Puesta la vara: **motor 9, aprobado 6** — el motor está **peor** que el modelo. Diagnóstico: dentro de cada firma hay una **moda y unas pocas desviadas** (firma 6: 1.057 cm en cuatro láminas y 0.978/1.148/1.354 en tres; firma 3: 2.017 en tres, 1.654 y 2.492 en otras), que encaja con que el cromo —título de dos líneas, leyenda— come alto distinto y la barra absorbe la diferencia. La reparación es unidad propia: anclar el grosor al alto nominal del área de barras, no al residual tras el cromo |
