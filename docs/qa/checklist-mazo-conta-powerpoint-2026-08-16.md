...
| P45 | **Una lámina mixta no pone de acuerdo sus dos bloques** (sale de partir P44) | los dos graficadores deciden el grosor por separado; ninguno ve al otro | ☐ **ABIERTO, con la cifra**. Ahí está todo el desnivel de B3: el aprobado mantiene su bloque de escala y su bloque de barras simples a **1.5 mm** de diferencia como mucho; el motor llega a **4.2 mm**. Caso peor, **lámina 41**: rampa **1.041 cm con dos barras** contra azul **1.466 cm con tres** — el que tiene **más** barras sale **más grueso**, que es lo contrario de lo que haría un reparto de altura. **No se arregla dentro de un graficador**: la decisión tendría que tomarse a nivel de lámina, y ahí manda `reporte_plan_ppt.R`, que está congelado a crecimiento. Medir primero **por qué** el azul de la 41 se estira más, antes de proponer dónde vive el acuerdo |
