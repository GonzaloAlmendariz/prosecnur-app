...
| L8 | **Estética**: colores por eslabón, borde entre bloques, categorías en mayúsculas | `carga_aulas_libro_formato.R` | ☑ `6cf96582` + `c6e521ad` |
| L9 | **Hoja de indicadores** para campo y analista | `carga_aulas_libro_indicadores.R` | ☑ `9e445b6e` — «Cómo va el campo», la última antes de Listas |
