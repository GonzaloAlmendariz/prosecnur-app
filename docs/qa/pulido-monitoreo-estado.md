...
|---|---|---|---|---|---|
| pendiente de comprobar | acreditación | Teléfono › Resumen | El mismo bloque «Equipo asignado» que se arregló en telefónico lo renderiza también acreditación, pero **cada modo tiene su propia hoja** —`telefonicoProfile.css` frente a `acreditacionTelefono.css`, que no declara la clase—, así que el arreglo no le llega. Hay que medirlo allí antes de duplicar la regla | 2026-07-30 | abierto |
