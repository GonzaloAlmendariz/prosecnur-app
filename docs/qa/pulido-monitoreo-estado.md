...
|---|---|---|---|---|---|
| **corrección de método** | territorial y acreditación | tablas de revisión | Los recortes en celda se venían dejando abiertos con el argumento de que «envolver redistribuye las columnas». **Se comprobó y es falso** al menos en `register-table`: no es una tabla sino una rejilla con columnas ya resueltas, y envolver las deja idénticas al píxel —84 recortes a cero, filas largas a dos líneas—. Las otras tres tablas con el mismo hallazgo —Fuente › Encuestadores (8), Consultas internas (10) y Cruces efectivos de acreditación (45)— hay que **medirlas igual** antes de repetir la excusa | medido el 2026-07-30 en `acnur_acg` | corregido aquí, pendiente en las otras tres |
