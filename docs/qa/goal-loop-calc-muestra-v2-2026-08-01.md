...
| 19 | «Cálculo» (renombre + Distribución densa) | M4 | **activa** — capacidad completa; auditoría es su primer paso, no un lote aparte |
...
- **Baseline inicial:** I18b deja R/HTTP y frontend focales verdes, typecheck verde, QA real de criterios en 4/4 capturas y 466 grupos con contadores duros en cero. La auditoría I19 medirá contratos, geometría y faltantes propios de Cálculo antes de editar.
