...
.public_artifact_normalize <- function(artifact = NULL, fallback_title = "Prosecnur") {
  ...
  list(
    ...
    audience = .public_scalar(artifact$audience, if (identical(kind, "monitoreo")) "client" else ""),
    profile_family = .public_scalar(artifact$profile_family, ""),
    publication_family = .public_scalar(artifact$publication_family, artifact$monitoring_family %||% ""),
    monitoring_family = .public_scalar(artifact$monitoring_family, artifact$publication_family %||% artifact$profile_family %||% ""),
    destination = .public_scalar(artifact$destination, ""),
    source = .public_scalar(artifact$source, ""),
    namespace = .public_scalar(artifact$namespace, ""),
