...
export const IconConditionalLogic = GitBranch; // relevant, visibilidad condicional, saltos
export const IconBranching = IconConditionalLogic; // alias legacy para lógica de saltos
