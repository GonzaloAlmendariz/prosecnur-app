...
// del page-file congelado (TelefonicoMonitoreoPage.tsx). Copia por perfil
// deliberada (mismo criterio que pollSourceSync): este perfil es un fork vivo
// de acreditación y su gemelo vive en acreditacion/sync/useSourceSyncActions.ts.
