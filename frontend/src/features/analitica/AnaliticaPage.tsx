...
function StepperChip({
  ...
  meta: ReporteMeta; active: boolean; last: boolean; onClick: () => void;
}) {
  ...
  return (
    ...
    >
      <span style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 13, fontWeight: 700, letterSpacing: -0.1 }}>
        <Icon size={14} />
        {meta.label}
      </span>
